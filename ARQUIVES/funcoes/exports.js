...
const { addBanned, unBanned, BannedExpired, cekBannedUser } = require("../../ARQUIVES/js/banned.js");
    const namoro1 = JSON.parse(fs.readFileSync("./DADOS DO KEISEN/func/namoro1.json"));
const namoro2 = JSON.parse(fs.readFileSync("./DADOS DO KEISEN/func/namoro2.json"));
...
const { wait, getExtension, generateMessageID, getMembros, getMembrosNoAdmin, getGroupAdmins, normalizeJid, getRandom, banner, banner2, banner3, temporizador, chyt, getBuffer, fetchJson, fetchText, createExif, getBase64, convertSticker, upload, nit, getpc, supre, recognize, pegarCases, carregarMidia } = require('../../ARQUIVES/funcoes/functions.js'); // É necessário para algumas funções funcionar perfeitamente.
const { responderIA, chatGPT, geminiIA } = require('../../ARQUIVES/funcoes/ia.js');
...
// [JSON] - Funções Abaixo >>> :
const pushnames = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/usuarios/users.json'));
const obrigadoEXT = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/INFO_KEISEN/media/nescessario.json'))
const rgtake = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/usuarios/take.json'));
const sotoy = JSON.parse(fs.readFileSync('./ARQUIVES/json/sotoy.json'));
const countMessage = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/INFO_KEISEN/media/countmsg.json'));
const comandos = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/INFO_KEISEN/media/comandos.json'));
const daily = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/usuarios/diario.json'));
const nescessario = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/INFO_KEISEN/media/nescessario.json'));
const vip = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/usuarios/vip.json'));
const ban = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/usuarios/banned.json'));
const muted = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/grupos/muted.json'))
const limitefll = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/usuarios/flood.json'));
const joguinhodavelhajs = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/usuarios/joguinhodavelha.json'));
const joguinhodavelhajs2 = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/usuarios/joguinhodavelha2.json'));
const antispam = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/INFO_KEISEN/media/antispam.json'));
    const level2 = JSON.parse(fs.readFileSync("./DADOS DO KEISEN/usuarios/leveling.json"));
const anotar = JSON.parse(fs.readFileSync("./DADOS DO KEISEN/func/anotar.json"));
const setting = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/INFO_KEISEN/media/INFO_KEISEN.json'));
const logoslink = JSON.parse(fs.readFileSync('./DADOS DO KEISEN/INFO_KEISEN/LOGOS/links_img.json'));
const Limit_CMD = JSON.parse(fs.readFileSync("./DADOS DO KEISEN/func/limitarcmd.json"))
...
const { linguagem, mess, getInfo } = require('../../DADOS DO KEISEN/INFO_KEISEN/lib');
...
var EnvBotao = async (id, MR, KEISEN, text1, desc1, X) => {
if(X.split("|")[1] != "0") {
KEISEN.sendMessage(id, {image: {url: X.split("|")[1]}, caption: text1, mentions: [MR]})} else {KEISEN.sendMessage(id, {text: text1, mentions: [MR]})}}
} else {
var EnvBotao = async(id, MR, KEISEN, text1, desc1, X, TXT = [], vr) => {
...
KEISEN.sendMessage(id, buttonMessage, {quoted: vr}).catch(e => {
...
const listCommands = (targetWord) => {
      const fileContent = fs.readFileSync("KEISEN.js", "utf8");
...
module.exports = { extractDDD, extractStateFromNumber, extractStateFromDDD, formatDateOriginal, awaitMessage, LoggerB, readline, P, fs, util, Boom, axios, linkfy, request, ms, ffmpeg, fetch, qrterminal, exec, extractMetadata, spawn, execSync, limitefll, moment, time, hora, date, os, getBuffer, convertSticker, fetchJson, fetchText, getBase64, createExif, writeExifImg, upload, nit, addBanned, unBanned, BannedExpired, cekBannedUser, validmove, setGame, addComandosId, deleteComandos, getComandoBlock, getComandos, addComandos, palavrasANA, quizanimais, getpc, supre, wait, getExtension, generateMessageID, getGroupAdmins, normalizeJid, getMembros, getMembrosNoAdmin, getRandom, banner, banner2, banner3, temporizador, chyt, simih, antispam, anotar, sotoy, countMessage, comandos, daily, muted, nescessario, vip, ban, joguinhodavelhajs, joguinhodavelhajs2, setting, logoslink, linguagem, getInfo, mess, destrava, destrava2, tabela, recognize, colors, cheerio, NodeCache, kyun, TimeCount, sendVideoAsSticker, sendImageAsSticker, sendVideoAsSticker2,level2,sendImageAsSticker2, enviarfiguUrl, sendPoll, getFileBuffer, DLT_FL, sleep, ANT_LTR_MD_EMJ, convertBytes, arcloud, identificarMusica, os, garticArchives, enigmaArchive, isFiltered, addFilter, psycatgames, speed, vyroEngine, AssemblyAI, whatMusicAr, quizFutebol, obeso, countDays, timeDate, writeExif2, Limit_CMD, capitalizeFirstLetter, emoji, formatNumber, formatNumberDecimal, isJsonIncludes, pushnames, shuffle, packname, advices, tools, getName, listCommands, namoro1, namoro2, obrigadoEXT, addNumberMais, identArroba, pegarCases, carregarMidia, responderIA, chatGPT, geminiIA }
